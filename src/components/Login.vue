<!-- 样式来源:https://mp.weixin.qq.com/s/lWoR_1X-USsLRv8ClQ-Bzg -->
<template>
  <div class="viewBody">
    <div class="color"></div>
    <div class="color"></div>
    ...
    <div class="box">
      ...
      <div class="container">
        <div class="form">
          ...
          <form>
            <div class="inputBox">
              <input type="text" v-model="login.userName" placeholder="登录" />
            </div>
            <div class="inputBox">
              <input
                type="password"
          ...
          <p class="forget">没有账户？<a href="#">点击注册</a></p>
        </div>
      </div>
    </div>
  </div>
